    ...
    <div className="grid grid-cols-3 gap-3 sm:grid-cols-4 lg:grid-cols-6">
      {items.map((item, index) => {
        ...
        return (
          ...
          >
            <div className="skill-hover text-white rounded-md w-full p-1 sm:p-2 overflow-hidden group-hover:ring-1 ring-gray-200 relative z-20 transition-all duration-500">
