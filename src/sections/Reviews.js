...
const Reviews = () => {
  return (
    <div className="flex flex-row flex-wrap gap-1 justify-evenly max-w-6xl mx-auto mb-16">
      <ReviewCard
      ...
      >
        <div className="m-4 text-md md:text-lg flex flex-col justify-center gap-4">
